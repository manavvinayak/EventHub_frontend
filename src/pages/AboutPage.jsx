    ...
    <div className="min-h-[calc(100vh-160px)] bg-primary">
      ...
      <section className="relative   py-20 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          <h1 className="text-5xl md:text-7xl font-bold text-cardBg-royal mb-6">
            About EventHub
          </h1>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              <div>
                <h2 className="text-4xl md:text-5xl font-bold text-cardBg-purple bg-clip-text   mb-6">
                  Our Mission
                </h2>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="bg-white p-4 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300">
                    <div className="w-10 h-10 bg-cardBg-royal rounded-lg flex items-center justify-center mb-3">
                      <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="bg-white p-4 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300">
                    <div className="w-10 h-10 bg-cardBg-purple rounded-lg flex items-center justify-center mb-3">
                      <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl font-bold text-cardBg-royal mb-8">Our Vision</h2>
      ...
      <section className="py-20 bg-primary-light  ">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold text-cardBg-royal mb-6">Ready to Get Started?</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="/events"
              className="bg-button-purple text-white px-8 py-4 rounded-xl font-bold   "
            >
              Browse Events
            </a>
            <a
              href="/signup"
              className="bg-button-purple text-white px-8 py-4 rounded-xl font-semibold hover:bg-indigo-800 transition-colors duration-300 hover:scale-105 transform border-2 border-indigo-500"
            >
              Join EventHub
            </a>
          </div>
