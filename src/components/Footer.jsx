        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="/events" className="text-gray-300 hover:text-white transition-colors duration-300">Browse Events</a></li>
              <li><a href="/about" className="text-gray-300 hover:text-white transition-colors duration-300">About Us</a></li>
              <li><a href="/dashboard" className="text-gray-300 hover:text-white transition-colors duration-300">Dashboard</a></li>
            </ul>
          </div>
