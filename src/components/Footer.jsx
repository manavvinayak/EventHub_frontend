...
function Footer() {
  return (
    <footer className="bg-cardBg-brown text-white relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              <div className="w-10 h-10 bg-cardBg-royal rounded-xl flex items-center justify-center">
            ...
            <p className="text-gray-300 mb-6 max-w-md leading-relaxed">
              Your one-stop platform for discovering and managing college club events. Connect, participate, and never miss out on exciting opportunities!
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/events" className="text-gray-300 hover:text-white transition-colors duration-300">Browse Events</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="mailto:support@eventhub.com" className="text-gray-300 hover:text-white transition-colors duration-300">Help Center</a></li>
              <li><a href="mailto:contact@eventhub.com" className="text-gray-300 hover:text-white transition-colors duration-300">Contact Us</a></li>
              <li><button onClick={() => alert('Privacy Policy coming soon!')} className="text-gray-300 hover:text-white transition-colors duration-300 text-left">Privacy Policy</button></li>
              <li><button onClick={() => alert('Terms of Service coming soon!')} className="text-gray-300 hover:text-white transition-colors duration-300 text-left">Terms of Service</button></li>
            </ul>
          </div>
        </div>
